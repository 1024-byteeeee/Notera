...
ScoreListModel::ScoreListModel(QObject* parent) : QAbstractListModel(parent) {}
...
int ScoreListModel::count() const { return m_scores.size(); }
...
QVariant ScoreListModel::data(const QModelIndex& index, const int role) const
{
    ...
    case CreatedDateRole:
        return score.createdAt.toLocalTime().toString(QStringLiteral("yyyy-MM-dd"));
    case PageCountRole:
        return score.pageCount;
    case ThumbnailPathRole:
        return score.thumbnailPath;
    case FavoriteRole:
        return score.favorite;
    case FilePathRole:
        return score.filePath;
    case FileTypeRole:
        return score.fileType;
    default:
        return {};
    }
}
...
{
    return {{IdRole, "scoreId"},          {TitleRole, "title"},
            {ComposerRole, "composer"},   {CreatedDateRole, "createdDate"},
