...
class PdfRenderCache final : public QObject
{
  ...
  public:
    ...
    Q_INVOKABLE QImage get(int page, qreal scale, int rotation, int tileRow = -1, int tileCol = -1);

    Q_INVOKABLE bool has(int page, qreal scale, int rotation, int tileRow = -1,
                         int tileCol = -1) const;
    ...
    static QString makeKey(int page, qreal scale, int rotation, int tileRow = -1, int tileCol = -1);
