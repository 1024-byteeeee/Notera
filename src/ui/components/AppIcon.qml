...
Canvas {
    ...
    onPaint: {
        ...
        if (name === "plus" || name === "minus") {
            ...
            if (name === "open") {
                rect(4, 6, 14, 14, 2)
                line([[11, 13], [20, 4]]); line([[14, 4], [20, 4], [20, 10]])
            } else if (name === "import") {
                rect(4, 6, 14, 14, 2)
                line([[12, 3], [12, 15]]); line([[8.5, 11.5], [12, 15], [15.5, 11.5]])
            } else {
                rect(4, 10, 14, 10, 2)
                line([[12, 3], [12, 13]]); line([[8.5, 6.5], [12, 3], [15.5, 6.5]])
            }
        } else if (name === "music") {
