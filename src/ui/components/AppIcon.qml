    ...
    onPaint: {
        ...
        if (name === "plus" || name === "minus") {
            ...
            for (let i = 1; i < points.length; ++i)
                ctx.lineTo(points[i][0], points[i][1]);
            ctx.closePath();
            name === "star-filled" ? ctx.fill() : ctx.stroke();
        } else if (name === "edit") {
            ...
            line([[10, 10], [10.5, 17]]);
            line([[14, 10], [13.5, 17]]);
        } else if (name === "open" || name === "import" || name === "export") {
            if (name === "open") {
                rect(4, 6, 14, 14, 2);
                line([[11, 13], [20, 4]]);
                ...
                rect(4, 6, 14, 14, 2);
                line([[12, 3], [12, 15]]);
                line([[8.5, 11.5], [12, 15], [15.5, 11.5]]);
            } else {
                rect(4, 10, 14, 10, 2);
                line([[12, 3], [12, 13]]);
                line([[8.5, 6.5], [12, 3], [15.5, 6.5]]);
            }
        } else if (name === "music") {
            line([[10, 18], [10, 6], [19, 4], [19, 16]]);
            line([[10, 8], [19, 6]]);
            circle(7.5, 18, 2.5, true);
            circle(16.5, 16, 2.5, true);
        } else if (name === "recent") {
            circle(12, 12, 8, false);
            ...
            if (name === "chevron-down")
                line([[6, 9], [12, 15], [18, 9]]);
            else if (name === "chevron-right" || name === "next")
                line([[9, 5], [16, 12], [9, 19]]);
            else
            ...
            ctx.fillRect(7, 5, 3.5, 14);
            ctx.fillRect(13.5, 5, 3.5, 14);
        } else if (name === "rotate-left" || name === "rotate-right" || name === "reset") {
            ctx.beginPath();
            ctx.arc(12, 12, 7, name === "rotate-right" ? -2.5 : -0.6, name === "rotate-right" ? 0.6 : 2.5, name !== "rotate-right");
            ctx.stroke();
