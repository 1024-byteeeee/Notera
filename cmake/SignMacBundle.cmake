...
if(NOT EXISTS "${bundle_path}")
  message(
    FATAL_ERROR "Notera bundle was not staged for signing: ${bundle_path}")
endif()
...
execute_process(
  COMMAND /usr/bin/codesign --force --sign "${signing_identity}"
          "${bundle_path}"
  RESULT_VARIABLE signing_result
  ERROR_VARIABLE signing_error)
if(NOT signing_result EQUAL 0)
...
if(NOT verification_result EQUAL 0)
  message(
    FATAL_ERROR
      "Notera signature verification failed: ${verification_output}${verification_error}"
  )
endif()
